...
SWIGINTERN PyObject *_wrap_parse_line(PyObject *self, PyObject *args) {
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "parse_line" "', argument " "2"" of type '" "std::vector< std::string > &""'");
  }
...
SWIGINTERN PyObject *_wrap_intlist(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!argp1) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "intlist" "', argument " "1"" of type '" "string""'");
    } else {
...
SWIGINTERN PyObject *_wrap_lassoD__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    delete result;
    resultobj = SWIG_Python_AppendOutput(resultobj, tuple, 0);
  }
  {
    if(data_temp3 != NULL) {
      ...
      resultobj = SWIG_Python_AppendOutput(resultobj, (PyObject*)array, 0);
    }
  }
  {
    delete arg1;
...
SWIGINTERN PyObject *_wrap_simpleGroupTree(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    del_gstruct(result);
    resultobj = SWIG_Python_AppendOutput(resultobj, node_list, 0);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_treeOfGroupStruct__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  resultobj = SWIG_From_int(static_cast< int >(result));
  {
    ...
    if (!array) SWIG_fail;
    resultobj = SWIG_Python_AppendOutput(resultobj, obj, 0);
  }
  {
    if(data_temp4 != NULL) {
      npy_intp n = data_temp4->n();
