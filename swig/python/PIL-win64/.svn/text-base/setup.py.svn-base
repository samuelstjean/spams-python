...
vcdir = 'C:/Program Files (x86)/Microsoft Visual Studio 9.0/VC/include'
vclib= 'C:/Program Files (x86)/Microsoft Visual Studio 9.0/VC/lib/amd64'
class pil_build_ext(build_ext):
    ...
    def build_extensions(self):
        ...
        library_dirs = []
        include_dirs = []
        add_directory(include_dirs, vcdir)
        add_directory(library_dirs, vclib)
