...
mkdir -p /c/openblas/if_32/64/lib/pkgconfig
...
mkdir -p /c/openblas/openblas_dll
which strip
...
cp /c/openblas/if_32/64/bin/*.dll /c/openblas/openblas_dll
cp /c/openblas/if_32/64/bin/include /c/openblas/
cp /c/openblas/if_32/64/bin/lib /c/openblas/
